...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="parse vcard (.vcf) contact files", formatter_class=usage_style
    )
    parser.add_argument(
        "--hatchbuck",
        type=str,
    ...
    parser.add_argument(
        ...
        default=vdirsync_user,
        required=not vdirsync_user,
    )
    parser.add_argument(
        "--vdirsync-pass",
        type=str,
        help="vdirsync password (env: VDIRSYNC_PASS)",
        default=vdirsync_pass,
        required=not vdirsync_pass,
    )
    parser.add_argument(
        "--vdirsync-url",
        type=str,
        help="vdirsync URL (env: VDIRSYNC_URL)",
        default=vdirsync_url,
        required=not vdirsync_url,
    )
    ...
    parser.add_argument(
        "-u",
        "--update",
        help="only update existing contacts in hatchbuck," " don't add new ones",
        action="store_true",
        default=False,
    )
    parser.add_argument(
    ...
    parser.add_argument("dir", help="read all vcf files from directories", nargs="*")
